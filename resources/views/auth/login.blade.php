...
@section('content')
  ...
  @php
    ...
    $roleName = $roleLabels[$role] ?? 'Teacher';
  @endphp
  ...
  @if (session('status'))
    <div class="verify-note" style="background:#eefaf0;">
    ...
    <div class="field">
      ...
      <div style="position:relative;">
        ...
        <button type="button" id="togglePw" aria-label="Show password"
                style="position:absolute; right:10px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; color:var(--slate-400); padding:4px; display:flex;">
