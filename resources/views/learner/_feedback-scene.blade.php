{{--
  ...
  Optional: $dotsDone + $dotsTotal (progress dots), $level (the level pill),
            $newBadges (badges just earned: code, name, description; each is
            shown with its own icon, see _badge-icon).
--}}
<!DOCTYPE html>
<html lang="en">
<head>
...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  @media (max-width:860px){
    ...
    .fb-talk{ align-items:center; text-align:center; padding-top:8px; }
