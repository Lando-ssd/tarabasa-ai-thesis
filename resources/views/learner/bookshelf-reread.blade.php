...
<style>
  ...
  *{box-sizing:border-box;} html,body{margin:0;padding:0;}
  ...
  .free-note{
    ...
    background:#fff3e2; border:1px solid var(--owl-orange-500); border-radius:999px; padding:6px 14px; margin-bottom:18px;
  }
  .passage-card{
...
<div class="wrap">
  <div class="card">
    ...
    <p class="sub">Reading it again just for fun!</p>
    <div class="free-note">🎈 Free practice — no points, just for fun</div>
